  ...
  return (
    <div className="w-full flex pt-32 justify-center" id="pricing">
      <stripe-pricing-table
        ...
        pricing-table-id="prctbl_1MxtcyLo0vNAy2SyIiT7Da95"
        publishable-key="pk_test_51MEpezLo0vNAy2Syp779L8j60npRdCKDgWDrjYvzBdbQ6nzRFl3qDW4EbiurQLqCvwXgC2NcP6Wm0FvyfvABKkWO00Y196o3vC"
        // customer-email="testlocation_FR@email.com"
      ></stripe-pricing-table>
    </div>
  );
};
