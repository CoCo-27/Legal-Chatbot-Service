      ...
      <div className="flex m-auto w-full max-w-lg">
        ...
        >
          ...
          <p className="mb-8 text-base text-txGray">
            Miss-placed your password ? Don't worry- we'll get you back to Case
            Cruncher in no time!
          </p>
          <input
            name="email"
          ...
          />
          <button
            className="mb-8 tracking-wide font-semibold bg-blue-300 text-white w-full py-4 rounded-lg hover:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.3),0_4px_18px_0_rgba(51,45,45,0.2)] transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
            type="submit"
            disabled={loading}
          >
            {!loading ? (
